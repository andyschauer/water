...
header = f"""
    ...
    <h2>{instrument['name']} Report - {dt.datetime.fromtimestamp(inj['time']['mean'][0], dt.UTC).strftime('%Y-%m-%d')} to {dt.datetime.fromtimestamp(inj['time']['mean'][-1], dt.UTC).strftime('%Y-%m-%d')}</h2>
